...
public class ServicoController implements Serializable{
    ...
    public String salvar(){
        ...
        UtilMensagens.mensagemErro("Erro", "Ocorreu um erro ao salvar a serviço!");
        return null;
    }
    ...
    public String alterar(){
        ...
        UtilMensagens.mensagemErro("Erro", "Ocorreu um erro ao alterar a serviço!");
        return null;
    }
    ...
    public String excluir(Servico servico){
        ...
        UtilMensagens.mensagemErro("Erro", "Ocorreu um erro ao excluir a serviço!");
        return null;
    }
